<template>
  <div>
    <n-space
      ...
      vertical
    >
      <h2>{{ translatedWord('people_group.need_to_change') }}</h2>
      ...
      >
        ...
        {{ translatedWord('this_people_group_is_in_trash') }}
      </n-alert>
      ...
      <n-table :single-line="false">
        <tbody>
          ...
          <tr>
            <td>
              <div><b>{{ translatedWord('translations') }}</b></div>
              <p>{{ data.translations }}</p>
            </td>
          </tr>
        </tbody>
      </n-table>
