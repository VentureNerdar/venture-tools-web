          ...
          <tr>
            <td>
              <p>{{ h.translate('church_members_count') }} :
                <span style="padding-left: 5px;">{{ data.church_members_count ? data.church_members_count : '0'
                }}</span>
              </p>
            </td>
            ...
            <td>
              <p>{{ h.translate('confession_of_faith_count') }} :
                <span style="padding-left: 5px;">{{ data.confession_of_faith_count ? data.confession_of_faith_count :
                  '0' }}</span>
              </p>
            </td>
