...
>
  ...
  import type { PeopleGroupFormModel } from '~/types'
  ...
  type ModelRefType = Ref<PeopleGroupFormModel>

  // Self Ref : Need to set a module
  const module = modules.peopleGroups
  ...
  const p = withDefaults(defineProps<{
    editData: false | PeopleGroupFormModel,
   ...
   */
  const modelRef: ModelRefType = ref({ ...p.editData !== false ? p.editData : module.form.model as PeopleGroupFormModel })
