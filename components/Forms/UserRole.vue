<template>
  ...
  >
    ...
    <n-form-item
      path="label"
      :label="h.translate('label')"
    >
      <n-input v-model:value="d.model.label" :placeholder="h.translate('please_input')" />
    ...
    >
      <n-input v-model:value="d.model.description" :placeholder="h.translate('please_input')" />
...
>
  ...
  import type { UserRoleFormModel } from '~/types'
  ...
  type ModelRefType = Ref<UserRoleFormModel>
...
const h = useHelpers()
  ...
  const p = withDefaults(defineProps<{
    editData: false | UserRoleFormModel,
   ...
   */
  const modelRef: ModelRefType = ref({ ...p.editData !== false ? p.editData : module.form.model as UserRoleFormModel })
