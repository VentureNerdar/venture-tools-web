<template>
  ...
  >
    <n-card
      size="small"
      :class="`data-display ${isMobile ? 'mobile' : ''}`"
    >
      <n-space
        vertical
        :size="10"
      >
        ...
        >
          <n-flex :gap="10">
            ...
            <!-- QUICK FILTER -->
            <div v-if="p.module.options.filter !== false && !isMobile">
            ...
            <div v-if="p.module.options.filter !== false && isMobile">
              <n-button
                ...
                @click="mobileFilterDrawerState = true"
              >
                <template #icon>
                  <n-icon>
                    <FilterAltRound />
              ...
              <n-drawer
                v-model:show="mobileFilterDrawerState"
                placement="bottom"
              >
                <n-drawer-content class="mobile-filter-content">
                  <template #header>
                    <n-flex
                  ...
                  </n-radio-group> <!-- e.o Single Filter -->
            ...
            <div v-if="p.module.hasSoftDelete">
              <DisplaysTrash @trash-view-toggled="m.handle.emits.trashViewToggled" />
            </div>
            <!-- e.o VIEW TRASH TOGGLE -->

            <!-- SERACH -->
            <div
              :style="`display: inline; ${isMobile ? 'width: calc(100% - ' + (p.module.options.filter === false ? '100px' : '150px') + '); max-width: none;' : ''}`"
            >
              <n-input
                size="small"
            ...
            >
              <template #icon>
                <component :is="p.formModalOptions.components.buttonIconComponent
        ...
        <DisplaysMobileList
          ...
          :module="p.module"
          :is-trashed="d.visibility.trash"
          @editClicked="m.handle.click.editButton"
          @delete="m.handle.emits.deleteProgress"
        />
      </n-space>
    </n-card>
