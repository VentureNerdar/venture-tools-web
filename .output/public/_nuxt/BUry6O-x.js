const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./DHxv3F9Y.js","./YtHq8OO6.js","./entry.DdNnWKwf.css","./CZO7QJqz.js","./DZz3KrMK.js"])))=>i.map(i=>d[i]);
import{V as ee,D as me,a$ as be,r as T,bA as _e,cv as ye}from"./YtHq8OO6.js";import{d as Ee,N as ve}from"./CZO7QJqz.js";import{e as Ie}from"./DZz3KrMK.js";const De=()=>{};var z={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const B=new Map,Rt=new Map,x=new Map;function X(t,e){try{t.container.addComponent(e)}catch(n){g.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function j(t){const e=t.name;if(x.has(e))return g.debug(`There were multiple attempts to register component ${e}.`),!1;x.set(e,t);for(const n of B.values())X(n,t);for(const n of Rt.values())X(n,t);return!0}function sn(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
