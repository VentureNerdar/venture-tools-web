import{r as m,_ as y,C as T,h as D,E as z,F as Ie,o as P,i as M,j as ke,v as ve,k as Se,l as Ae,m as S}from"./C45RVbce.js";import"./BxpEjOof.js";import"./Cm9BH2tJ.js";const X="@firebase/installations",R="0.6.14";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function en(e=ke()){return Yt().then(t=>{if(!t)throw d.create("unsupported-browser")},t=>{throw d.create("indexed-db-unsupported")}),D(M(e),"messaging").getImmediate()}async function tn(e,t){return e=M(e),Te(e,t)}function nn(e,t){return e=M(e),zt(e,t)}Jt();export{en as getMessaging,tn as getToken,Yt as isSupported,nn as onMessage};
