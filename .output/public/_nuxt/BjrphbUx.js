import{r as m,_ as y,C as T,a as D,E as z,F as Ie,o as P,g as M,b as ke,v as ve,i as Se,c as Ae,d as S}from"./DZTKI6_w.js";import"./CafCBvvZ.js";import"./BgZJJq5E.js";import"./BQ8t6om7.js";const X="@firebase/installations",R="0.6.14";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tn(e=ke()){return Yt().then(t=>{if(!t)throw d.create("unsupported-browser")},t=>{throw d.create("indexed-db-unsupported")}),D(M(e),"messaging").getImmediate()}async function nn(e,t){return e=M(e),Te(e,t)}function on(e,t){return e=M(e),zt(e,t)}Jt();export{tn as getMessaging,nn as getToken,Yt as isSupported,on as onMessage};
