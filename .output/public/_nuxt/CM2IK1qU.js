...
`,[u("strong",`
 ...
 `,[I("disabled",[z("&:hover","background-color: var(--n-color-checked-hover);"),z("&:active","background-color: var(--n-color-checked-pressed);")])])])]),Bo=Object.assign(Object.assign(Object.assign({},L.props),zo),{bordered:{type:Boolean,default:void 0},checked:Boolean,checkable:Boolean,strong:Boolean,triggerClickOnClose:Boolean,onClose:[Array,Function],onMouseenter:Function,onMouseleave:Function,"onUpdate:checked":Function,onUpdateChecked:Function,internalCloseFocusable:{type:Boolean,default:!0},internalCloseIsButtonTag:{type:Boolean,default:!0},onCheckedChange:Function}),Ho=fo("n-tag"),_o=io({name:"Tag",props:Bo,slots:Object,setup(r){const i=ho(null),{mergedBorderedRef:l,mergedClsPrefixRef:p,inlineThemeDisabled:c,mergedRtlRef:d}=go(r),s=L("Tag","-tag",So,Io,r,p);bo(Ho,{roundRef:Co(r,"round")});function n(){if(!r.disabled&&r.checkable){const{checked:o,onCheckedChange:a,onUpdateChecked:v,"onUpdate:checked":b}=r;v&&v(!o),b&&b(!o),a&&a(!o)}}function t(o){if(r.triggerClickOnClose||o.stopPropagation(),!r.disabled){const{onClose:a}=r;a&&ko(a,o)}}const f={setTextContent(o){const{value:a}=i;a&&(a.textContent=o)}},k=vo("Tag",d,p),g=N(()=>{const{type:o,size:a,color:{color:v,textColor:b}={}}=r,{common:{cubicBezierEaseInOut:m},self:{padding:B,closeMargin:H,borderRadius:$,opacityDisabled:M,textColorCheckable:R,textColorHoverCheckable:_,textColorPressedCheckable:T,textColorChecked:E,colorCheckable:O,colorHoverCheckable:W,colorPressedCheckable:j,colorChecked:w,colorCheckedHover:A,colorCheckedPressed:q,closeBorderRadius:X,fontWeightStrong:Y,[h("colorBordered",o)]:G,[h("closeSize",a)]:J,[h("closeIconSize",a)]:Q,[h("fontSize",a)]:Z,[h("height",a)]:F,[h("color",o)]:oo,[h("textColor",o)]:eo,[h("border",o)]:ro,[h("closeIconColor",o)]:U,[h("closeIconColorHover",o)]:lo,[h("closeIconColorPressed",o)]:ao,[h("closeColorHover",o)]:co,[h("closeColorPressed",o)]:no}}=s.value,P=mo(H);return{"--n-font-weight-strong":Y,"--n-avatar-size-override":`calc(${F} - 8px)`,"--n-bezier":m,"--n-border-radius":$,"--n-border":ro,"--n-close-icon-size":Q,"--n-close-color-pressed":no,"--n-close-color-hover":co,"--n-close-border-radius":X,"--n-close-icon-color":U,"--n-close-icon-color-hover":lo,"--n-close-icon-color-pressed":ao,"--n-close-icon-color-disabled":U,"--n-close-margin-top":P.top,"--n-close-margin-right":P.right,"--n-close-margin-bottom":P.bottom,"--n-close-margin-left":P.left,"--n-close-size":J,"--n-color":v||(l.value?G:oo),"--n-color-checkable":O,"--n-color-checked":w,"--n-color-checked-hover":A,"--n-color-checked-pressed":q,"--n-color-hover-checkable":W,"--n-color-pressed-checkable":j,"--n-font-size":Z,"--n-height":F,"--n-opacity-disabled":M,"--n-padding":B,"--n-text-color":b||eo,"--n-text-color-checkable":R,"--n-text-color-checked":E,"--n-text-color-hover-checkable":_,"--n-text-color-pressed-checkable":T}}),C=c?uo("tag",N(()=>{let o="";const{type:a,size:v,color:{color:b,textColor:m}={}}=r;return o+=a[0],o+=v[0],b&&(o+=`a${D(b)}`),m&&(o+=`b${D(m)}`),l.value&&(o+="c"),o}),g,r):void 0;return Object.assign(Object.assign({},f),{rtlEnabled:k,mergedClsPrefix:p,contentRef:i,mergedBordered:l,handleClick:n,handleCloseClick:t,cssVars:c?void 0:g,themeClass:C==null?void 0:C.themeClass,onRender:C==null?void 0:C.onRender})},render(){var r,i;const{mergedClsPrefix:l,rtlEnabled:p,closable:c,color:{borderColor:d}={},round:s,onRender:n,$slots:t}=this;n==null||n();const f=V(t.avatar,g=>g&&y("div",{class:`${l}-tag__avatar`},g)),k=V(t.icon,g=>g&&y("div",{class:`${l}-tag__icon`},g));return y("div",{class:[`${l}-tag`,this.themeClass,{[`${l}-tag--rtl`]:p,[`${l}-tag--strong`]:this.strong,[`${l}-tag--disabled`]:this.disabled,[`${l}-tag--checkable`]:this.checkable,[`${l}-tag--checked`]:this.checkable&&this.checked,[`${l}-tag--round`]:s,[`${l}-tag--avatar`]:f,[`${l}-tag--icon`]:k,[`${l}-tag--closable`]:c}],style:this.cssVars,onClick:this.handleClick,onMouseenter:this.onMouseenter,onMouseleave:this.onMouseleave},k||f,y("span",{class:`${l}-tag__content`,ref:"contentRef"},(i=(r=this.$slots).default)===null||i===void 0?void 0:i.call(r)),!this.checkable&&c?y(po,{clsPrefix:l,class:`${l}-tag__close`,disabled:this.disabled,onClick:this.handleCloseClick,focusable:this.internalCloseFocusable,round:s,isButtonTag:this.internalCloseIsButtonTag,absolute:!0}):null,!this.checkable&&this.mergedBordered?y("div",{class:`${l}-tag__border`,style:{borderColor:d}}):null)}});export{_o as _,Ro as b,Ho as t};
