import{d as ee,r as L,ac as ut,h as c,ad as vt,ae as Z,af as ht,ag as gt,ah as Pe,ai as mt,j as Q,aj as xt,R as yt,ak as wt,al as St,am as Ct,an as Rt,Y as r,a0 as i,ao as S,$ as T,Z as Tt,a1 as We,a2 as zt,ap as ne,G as oe,a6 as ie,o as $t,Q as Pt,aq as j,E as Wt,ar as I,as as K,a3 as _t,at as ye,au as se,av as J,aw as Et,ax as At,ay as Lt,az as Bt,aA as kt}from"./CvgJilO_.js";import{A as jt}from"./BjxF08WS.js";import{t as It}from"./BjVeTqPo.js";import{d as we}from"./DwBiJwwL.js";import{u as Ht}from"./CMCM9tz_.js";import{c as Ot,b as Se,o as Ft}from"./sDTwY0VO.js";const Mt=Se(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[Se("&::-webkit-scrollbar",{width:0,height:0})]),Dt=ee({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=L(null);function n(d){!(d.currentTarget.offsetWidth<d.currentTarget.scrollWidth)||d.deltaY===0||(d.currentTarget.scrollLeft+=d.deltaY+d.deltaX,d.preventDefault())}const s=ut();return Mt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Ot,ssr:s}),Object.assign({selfRef:e,handleWheel:n},{scrollTo(...d){var x;(x=e.value)===null||x===void 0||x.scrollTo(...d)}})},render(){return c("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var Nt=/\s/;function Vt(e){for(var n=e.length;n--&&Nt.test(e.charAt(n)););return n}var Xt=/^\s+/;function Ut(e){return e&&e.slice(0,Vt(e)+1).replace(Xt,"")}var Ce=NaN,Gt=/^[-+]0x[0-9a-f]+$/i,Yt=/^0b[01]+$/i,qt=/^0o[0-7]+$/i,Kt=parseInt;function Re(e){if(typeof e=="number")return e;if(vt(e))return Ce;if(Z(e)){var n=typeof e.valueOf=="function"?e.valueOf():e;e=Z(n)?n+"":n}if(typeof e!="string")return e===0?e:+e;e=Ut(e);var s=Yt.test(e);return s||qt.test(e)?Kt(e.slice(2),s?2:8):Gt.test(e)?Ce:+e}var le=function(){return ht.Date.now()},Jt="Expected a function",Qt=Math.max,Zt=Math.min;function ea(e,n,s){var u,d,x,v,f,m,h=0,g=!1,_=!1,E=!0;if(typeof e!="function")throw new TypeError(Jt);n=Re(n)||0,Z(s)&&(g=!!s.leading,_="maxWait"in s,x=_?Qt(Re(s.maxWait)||0,n):x,E="trailing"in s?!!s.trailing:E);function y(b){var R=u,F=d;return u=d=void 0,h=b,v=e.apply(F,R),v}function z(b){return h=b,f=setTimeout(W,n),g?y(b):v}function C(b){var R=b-m,F=b-h,U=n-R;return _?Zt(U,x-F):U}function P(b){var R=b-m,F=b-h;return m===void 0||R>=n||R<0||_&&F>=x}function W(){var b=le();if(P(b))return $(b);f=setTimeout(W,C(b))}function $(b){return f=void 0,E&&u?y(b):(u=d=void 0,v)}function O(){f!==void 0&&clearTimeout(f),h=0,u=m=d=f=void 0}function A(){return f===void 0?v:$(le())}function p(){var b=le(),R=P(b);if(u=arguments,d=this,m=b,R){if(f===void 0)return z(m);if(_)return clearTimeout(f),f=setTimeout(W,n),y(m)}return f===void 0&&(f=setTimeout(W,n)),v}return p.cancel=O,p.flush=A,p}var ta="Expected a function";function de(e,n,s){var u=!0,d=!0;if(typeof e!="function")throw new TypeError(ta);return Z(s)&&(u="leading"in s?!!s.leading:u,d="trailing"in s?!!s.trailing:d),ea(e,n,{leading:u,maxWait:n,trailing:d})}const fe=gt("n-tabs"),_e={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},ba=ee({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:_e,slots:Object,setup(e){const n=Pe(fe,null);return n||mt("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:n.paneStyleRef,class:n.paneClassRef,mergedClsPrefix:n.mergedClsPrefixRef}},render(){return c("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),aa=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},Rt(_e,["displayDirective"])),be=ee({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:aa,setup(e){const{mergedClsPrefixRef:n,valueRef:s,typeRef:u,closableRef:d,tabStyleRef:x,addTabStyleRef:v,tabClassRef:f,addTabClassRef:m,tabChangeIdRef:h,onBeforeLeaveRef:g,triggerRef:_,handleAdd:E,activateTab:y,handleClose:z}=Pe(fe);return{trigger:_,mergedClosable:Q(()=>{if(e.internalAddable)return!1;const{closable:C}=e;return C===void 0?d.value:C}),style:x,addStyle:v,tabClass:f,addTabClass:m,clsPrefix:n,value:s,type:u,handleClose(C){C.stopPropagation(),!e.disabled&&z(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){E();return}const{name:C}=e,P=++h.id;if(C!==s.value){const{value:W}=g;W?Promise.resolve(W(e.name,s.value)).then($=>{$&&h.id===P&&y(C)}):y(C)}}}},render(){const{internalAddable:e,clsPrefix:n,name:s,disabled:u,label:d,tab:x,value:v,mergedClosable:f,trigger:m,$slots:{default:h}}=this,g=d??x;return c("div",{class:`${n}-tabs-tab-wrapper`},this.internalLeftPadded?c("div",{class:`${n}-tabs-tab-pad`}):null,c("div",Object.assign({key:s,"data-name":s,"data-disabled":u?!0:void 0},xt({class:[`${n}-tabs-tab`,v===s&&`${n}-tabs-tab--active`,u&&`${n}-tabs-tab--disabled`,f&&`${n}-tabs-tab--closable`,e&&`${n}-tabs-tab--addable`,e?this.addTabClass:this.tabClass],onClick:m==="click"?this.activateTab:void 0,onMouseenter:m==="hover"?this.activateTab:void 0,style:e?this.addStyle:this.style},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),c("span",{class:`${n}-tabs-tab__label`},e?c(yt,null,c("div",{class:`${n}-tabs-tab__height-placeholder`}," "),c(wt,{clsPrefix:n},{default:()=>c(jt,null)})):h?h():typeof g=="object"?g:St(g??s)),f&&this.type==="card"?c(Ct,{clsPrefix:n,class:`${n}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),ra=r("tabs",`
