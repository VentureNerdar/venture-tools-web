...
`,[C("splitor",`
 ...
 `),B("cursor-pointer",`
 cursor: pointer;
 `)]);function te(e){return`${e}-ellipsis--line-clamp`}function ae(e,o){return`${e}-ellipsis--cursor-${o}`}const no=Object.assign(Object.assign({},M.props),{expandTrigger:String,lineClamp:[Number,String],tooltip:{type:[Boolean,Object],default:!0}}),mo=P({name:"Ellipsis",inheritAttrs:!1,props:no,slots:Object,setup(e,{slots:o,attrs:n}){const s=Ae(),u=M("Ellipsis","-ellipsis",oo,Ee,e,s),h=D(null),m=D(null),v=D(null),a=D(!1),l=I(()=>{const{lineClamp:t}=e,{value:c}=a;return t!==void 0?{textOverflow:"","-webkit-line-clamp":c?"":t}:{textOverflow:c?"":"ellipsis","-webkit-line-clamp":""}});function f(){let t=!1;const{value:c}=a;if(c)return!0;const{value:r}=h;if(r){const{lineClamp:k}=e;if(z(r),k!==void 0)t=r.scrollHeight<=r.offsetHeight;else{const{value:y}=m;y&&(t=y.getBoundingClientRect().width<=r.getBoundingClientRect().width)}w(r,t)}return t}const g=I(()=>e.expandTrigger==="click"?()=>{var t;const{value:c}=a;c&&((t=v.value)===null||t===void 0||t.setShow(!1)),a.value=!c}:void 0);Me(()=>{var t;e.tooltip&&((t=v.value)===null||t===void 0||t.setShow(!1))});const d=()=>b("span",Object.assign({},Ue(n,{class:[`${s.value}-ellipsis`,e.lineClamp!==void 0?te(s.value):void 0,e.expandTrigger==="click"?ae(s.value,"pointer"):void 0],style:l.value}),{ref:"triggerRef",onClick:g.value,onMouseenter:e.expandTrigger==="click"?f:void 0}),e.lineClamp?o:b("span",{ref:"triggerInnerRef"},o));function z(t){if(!t)return;const c=l.value,r=te(s.value);e.lineClamp!==void 0?p(t,r,"add"):p(t,r,"remove");for(const k in c)t.style[k]!==c[k]&&(t.style[k]=c[k])}function w(t,c){const r=ae(s.value,"pointer");e.expandTrigger==="click"&&!c?p(t,r,"add"):p(t,r,"remove")}function p(t,c,r){r==="add"?t.classList.contains(c)||t.classList.add(c):t.classList.contains(c)&&t.classList.remove(c)}return{mergedTheme:u,triggerRef:h,triggerInnerRef:m,tooltipRef:v,handleClick:g,renderTrigger:d,getTooltipDisabled:f}},render(){var e;const{tooltip:o,renderTrigger:n,$slots:s}=this;if(o){const{mergedTheme:u}=this;return b(je,Object.assign({ref:"tooltipRef",placement:"top"},o,{getDisabled:this.getTooltipDisabled,theme:u.peers.Tooltip,themeOverrides:u.peerOverrides.Tooltip}),{trigger:n,default:(e=s.tooltip)!==null&&e!==void 0?e:s.default})}else return n()}});export{co as B,uo as F,ho as N,mo as _,po as a,go as b,fo as c,bo as d,so as e,vo as f,no as g,oo as h,te as i,ae as j,Ye as r,qe as s,lo as u};
