const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./C1esTE-v.js","./CT8Vtxko.js","./entry.BHekXVUV.css","./D1YZeuYH.js","./B7uyUjzP.js","./BpDzwQSV.js"])))=>i.map(i=>d[i]);
import{q as ee,i as me,bs as be,r as T,m as _e,ce as ye}from"./CT8Vtxko.js";import{d as Ee,N as ve}from"./D1YZeuYH.js";import{d as Ie}from"./BpDzwQSV.js";const De=()=>{};var z={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class st{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(it(n)){const a=n.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(n=>n).join(" ")}}function it(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const k="@firebase/app",Y="0.11.5";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gt(t){j(new A("platform-logger",e=>new st(e),"PRIVATE")),j(new A("heartbeat",e=>new Ut(e),"PRIVATE")),C(k,Y,t),C(k,Y,"esm2017"),C("fire-js","")}Gt("");var Kt="firebase",Jt="11.6.1";/**
 * @license
